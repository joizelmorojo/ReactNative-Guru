...
import { VSpageLoseStyles } from "./VSpageLoseStyles";
import {
  ...
  return (
    props.user && (
      <ScrollView style={styles.container}>
        <Loader />
        <Animated.View
          style={{ ...styles.topDiv, top: fromTop, opacity: faid }}
        >
          ...
          <Image
            source={require("../../allpngandsvg/sadRobo.png")}
            ...
            <View style={styles.lastList}>
              <View style={styles.indivisualMain}>
                ...
                <View style={styles.indivisual}>
                  <MyText style={styles.text1}>
                    {
                      currentResult.find((a) => a.result === `{roundscore}`)
                        .value
                    }{" "}
                    pts
                  </MyText>
              ...
              <View style={styles.indivisualMainActive}>
                <View style={styles.indivisual1}>
                  ...
                  <MyText style={styles.text1Active}>
                    {opponentResult &&
                      opponentResult.find((a) => a.result === `{correct}`)
                        .value}
                  </MyText>
                </View>
                <View style={styles.indivisual}>
                  ...
                  <MyText style={styles.text1Active}>
                    {opponentResult &&
                      opponentResult.find((a) => a.result === `{time}`)
                        .value}{" "}
                    seg
                  </MyText>
                </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(VSpageLose);
